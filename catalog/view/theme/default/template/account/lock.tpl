    ...
    <div class="main-forgot-pass">
      <div class="content-forgot">
        <div class="forgot-page text-center">
          ...
          <form action="lock.html" method="post" class="forgot-form">
            <div class="input-box">
              <div class="left-icon-forgot"><i class="icon icon_mail"></i></div>
              <div class="textbox-forgot"><input type="text" name="authenticator" value="" id="input-email" placeholder="Your authenticator code" id="input-password" class="form-control" /></div>
            </div>
