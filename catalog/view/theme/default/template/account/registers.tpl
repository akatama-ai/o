...
<link rel="stylesheet" type="text/css" href="catalog/view/theme/default/stylesheet/fakeloader.css" />
 ...
 <script src="catalog/view/javascript/register/register_personal.js" type="text/javascript"></script>
...
<div id="fakeloader"></div>
  ...
  <main>
        ...
        <form id="register-account" class="oe_signup_form" action="<?php echo $self -> url -> link('account/personal/register_submit', '', 'SSL'); ?>"  method="post" novalidate="novalidate">
          <?php if($p_binary) { ?>
         <input type="hidden" name="p_binary" value="<?php echo $p_binary ?>"/>
         <input type="hidden" name="postion" value="<?php echo $postion ?>">
         <?php } ?>
          <?php 
            $token = explode("_", $self -> request -> get['ref']);
