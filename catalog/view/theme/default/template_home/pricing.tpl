                     ...
                     <div class="pricing-table o_overflow_hidden row">
                           ...
                           <div class="pricing-card">
                              <div class="top">
                                 <div class="mt4 mb4 o_overflow_hidden">
                                    <h4 class="text-uppercase mb16 mt16">Plan 01</h4>
                                 </div>
                                 <div class="banner fw_regular">
                                    <b style=" font-size: 25px;">30</b> USD <br class="visible-md"/>
                                    <small>for</small>
                                    <b>70 days</b>
                                 </div>
                        ...
                        <div class="pricing-col online">
                           <div class="pricing-card">
                              <div class="top">
                                 <div class="mt4 mb4 o_overflow_hidden">
                                    <h4 class="text-uppercase mb16 mt16">Plan 02</h4>
                                 </div>
                                 <div class="banner fw_regular">
                                    <b style=" font-size: 25px;">100</b> USD <br class="visible-md"/>
                                    <small>for</small>
                                    <b>70 days</b>
                                 </div>
                                 <div class="suitable fw_regular text-heading">
                        ...
                        <div class="pricing-col description visible-xs-block visible-sm-block">
                           <div class="top">
                              <div class="suitable small text-heading fw_medium">Daily Rates:</div>
                           </div>
                           <div class="pricing-row text-heading text-left">Referral Program</div>
                        ...
                        <div class="pricing-col enterprise">
                           <div class="pricing-card">
                              <div class="top">
                                 <div class="mt4 mb4 o_overflow_hidden">
                                    <h4 class="text-uppercase mb16 mt16">Plan 03</h4>
                                 </div>
                                 <div class="banner fw_regular">
                                    <b style=" font-size: 25px;">500</b> USD <br class="visible-md"/>
                                    <small>for</small>
                                    <b>70 days</b>
                                 </div>
                                 <div class="suitable fw_regular text-heading">
                        ...
                        <div class="pricing-col enterprise">
                           <div class="pricing-card">
                              <div class="top">
                                 <div class="mt4 mb4 o_overflow_hidden">
                                    <h4 class="text-uppercase mb16 mt16">Plan 04</h4>
                                 </div>
                                 <div class="banner fw_regular">
                                    <b style=" font-size: 25px;">1,000</b> USD <br class="visible-md"/>
                                    <small>for</small>
                                    <b>80 days</b>
                                 </div>
                                 <div class="suitable fw_regular text-heading">
