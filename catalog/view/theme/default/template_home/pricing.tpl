      ...
      <div id="wrap" class="oe_structure">
                ...
                <div class="pricing-card">
                  <div class="top">
                    ...
                    <div class="banner fw_regular">
                      <b style=" font-size: 25px;">0.02</b> BTC <br class="visible-md"/>
                      <small>for</small>
                      <b>70 days</b>
                    </div>
                  ...
                  <div class="pricing-row"><b>2.2</b> % (<small>Mon - Sat</small>)</div>
        ...
        <div class="pricing-col enterprise">
                <div class="pricing-card">
                  <div class="top">
                    <div class="mt4 mb4 o_overflow_hidden">
                      <h4 class="text-uppercase mb16 mt16">ENTERPRISE</h4>
                    </div>
                    <div class="banner fw_regular">
